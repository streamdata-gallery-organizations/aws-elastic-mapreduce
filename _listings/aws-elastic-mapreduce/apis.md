...
- name: AWS Elastic MapReduce API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-elastic-mapreduce/master/_listings/aws-elastic-mapreduce/action-terminatejobflows-get.md
x-common:
- type: x-article
